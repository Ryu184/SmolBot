...
var Command = &commands.YAGCommand{
	...
	RunFunc: func(data *dcmd.Data) (interface{}, error) {
		info := fmt.Sprintf(`**SmolBot - YAGPDB - Yet Another General Purpose Discord Bot**
...
I'm currently being run and developed by Kana#1111 and Jonas747#0001 but the bot is open source (<https://github.com/Kanakonn/SmolBot>), so if you know Go and want to make some contributions, feel free to make a PR.
